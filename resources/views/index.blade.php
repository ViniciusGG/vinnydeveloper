...
@section('content')
    ...
    <!-- Header -->
    <header class="bg-football-dark-light backdrop-blur-sm fixed w-full top-0 z-50 border-b border-football-blue/20">
        <nav class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                <div
                    class="text-2xl font-bold bg-gradient-to-r from-football-blue to-football-yellow bg-clip-text text-transparent">
                    VG<span class="text-football-blue">⚽</span>
                </div>
    ...
    <!-- Home Section -->
    <section id="hero-section" class="min-h-screen flex items-center justify-center relative football-pattern parallax-bg">
        <div class="container mx-auto px-6 flex">
            <div class="max-w-4xl m-auto">
                <div class="mb-8">
                    <span class="text-2xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-white via-football-blue to-football-yellow bg-clip-text text-transparent gradient-animate">
                        Olá, eu sou
                    </span>
                    <h1
                        class="text-5xl md:text-7xl font-black mb-6 bg-gradient-to-r from-white via-football-blue to-football-yellow bg-clip-text text-transparent gradient-animate">
                        <span class="typing-animation">Vinicius Goulart</span>
                    </h1>
                    <p class="text-xl md:text-4xl mb-8 font-medium">
                        Desenvolvedor Full Stack
                    </p>
                    <p class="text-2xl md:text-2xl max-w-2xl mx-auto leading-relaxed">
                        Apaixonado por tecnologia e futebol.
                    </p>
                    <p class="text-2xl max-w-96 leading-relaxed">
                        Especialista em Laravel, Shopify, WordPress e Desenvolvimento de APIs.
                    </p>
                </div>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="#projetos"
                        class="bg-gradient-to-r from-football-blue to-green-600 hover:from-green-600 hover:to-football-blue text-white font-semibold py-2 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg pulse-glow gradient-animate">
                        Ver Projetos
                    </a>
                    <a href="#contato"
                        class="border-2 border-football-blue text-football-blue hover:bg-football-blue hover:text-white font-semibold py-2 px-8 rounded-lg transition-all duration-300 gradient-animate">
                        Entrar em Contato
                    </a>
                </div>
            </div>
            <div>
                <img src="{{ asset('storage/images/me.png') }}" alt="Vinicius Goulart" class="w-full h-full object-cover">
            </div>
        </div>
    ...
    <!-- Projects Section -->
    <section id="projects-section" class="py-20">
        <div class="container mx-auto px-6">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-16 ">
                    <h2
                        class="text-4xl md:text-5xl font-black mb-6 bg-gradient-to-r from-football-blue to-football-yellow bg-clip-text text-transparent gradient-animate">
                        Meus Projetos
                    </h2>
                    <div
                        class="w-24 h-1 bg-gradient-to-r from-football-blue to-football-yellow mx-auto mb-8 gradient-animate">
                    </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div
                        ...
                        <div
                            class="aspect-video bg-gradient-to-br from-football-blue/20 to-football-yellow/20   flex items-center justify-center gradient-animate">
                            <span class="text-4xl group-hover:scale-110 transition-transform duration-300">🏆</span>
                        </div>
                        <div class="p-6">
                            <h3
                                class="text-xl font-bold mb-3 text-gray-900  group-hover:text-football-blue transition-colors">
    ...
    <section id="contact-section" class="py-20">
        <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="w-24 h-1 bg-gradient-to-r from-football-blue to-football-yellow mx-auto mb-8 gradient-animate">
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8 mb-12">
                    <div
                        ...
                        <div
                            class="w-16 h-16 bg-football-blue/20  rounded-full flex items-center justify-center mb-4 gradient-animate">
                            <span class="text-2xl">📧</span>
                        </div>
                        <h3 class="text-lg font-semibold text-white  mb-2">Email</h3>
                        <a href="mailto:vinicius@example.com"
                    ...
                    <div
                        class="flex flex-col items-center p-6 bg-gray-900/50  rounded-xl border border-football-blue/20  hover:bg-gray-800/50  transition-all duration-300 pulse-glow ">
                        <div
                            class="w-16 h-16 bg-football-yellow/20  rounded-full flex items-center justify-center mb-4 gradient-animate">
                            <span class="text-2xl">📱</span>
                        </div>
                    ...
                    <div
                        class="flex flex-col items-center p-6 bg-gray-900/50  rounded-xl border border-football-blue/20  hover:bg-gray-800/50  transition-all duration-300 pulse-glow ">
                        <div
                            class="w-16 h-16 bg-green-600/20  rounded-full flex items-center justify-center mb-4 gradient-animate">
                            <span class="text-2xl">💼</span>
                        </div>
                ...
                <div class="bg-gray-900/50  rounded-xl p-8 border border-football-blue/20 ">
                    <form class="space-y-6">
                        ...
                        <button type="submit"
                            class="w-full bg-gradient-to-r from-football-blue to-green-600 hover:from-green-600 hover:to-football-blue text-white font-semibold py-4 px-8 rounded-lg transition-all duration-300">
                            Enviar Mensagem
                        </button>
                    </form>
                </div>
    ...
    <!-- Footer -->
    <footer class="bg-football-dark-light py-12 border-t border-football-blue/20">
        <div class="container mx-auto px-6">
            <div class="max-w-6xl mx-auto">
                <div class="flex flex-col md:flex-row items-center justify-between">
                    <div
                        class="text-2xl font-bold bg-gradient-to-r from-football-blue to-football-yellow bg-clip-text text-transparent mb-4 md:mb-0">
                        VG<span class="text-football-blue">⚽</span>
                    </div>
                    <div class="text-gray-400 text-center md:text-right">
                        <p>&copy; 2024 Vinicius Goulart. Todos os direitos reservados.</p>
